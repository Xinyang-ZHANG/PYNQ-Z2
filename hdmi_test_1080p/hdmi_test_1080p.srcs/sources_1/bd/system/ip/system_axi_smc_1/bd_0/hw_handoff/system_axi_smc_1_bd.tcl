...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC002_ROUTE {0b0000} \
   CONFIG.SSC003_ROUTE {0b0000} \
   CONFIG.SSC004_ROUTE {0b0100} \
   CONFIG.SSC005_ROUTE {0b1000} \
   CONFIG.SSC006_ROUTE {0b0000} \
   CONFIG.SSC007_ROUTE {0b0000} \
