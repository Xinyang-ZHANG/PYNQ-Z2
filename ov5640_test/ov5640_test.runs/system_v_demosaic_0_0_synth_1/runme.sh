...
HD_PWD='D:/self_learning/PYNQ_Z2/prjs/ov5640_test/ov5640_test.runs/system_v_demosaic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_v_demosaic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_v_demosaic_0_0.tcl
