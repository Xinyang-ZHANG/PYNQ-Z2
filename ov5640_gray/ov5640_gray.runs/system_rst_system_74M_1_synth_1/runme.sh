...
HD_PWD='D:/self_learning/PYNQ_Z2/prjs/ov5640_test/ov5640_test.runs/system_rst_system_74M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rst_system_74M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rst_system_74M_1.tcl
