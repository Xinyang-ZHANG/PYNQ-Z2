...
HD_PWD='D:/self_learning/PYNQ_Z2/prjs/ov5640_gray/ov5640_gray.runs/system_system_ila_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_system_ila_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_system_ila_1_1.tcl
