...
connect_bd_intf_net -intf_net Conn [get_bd_intf_ports SLOT_1_AXIS] [get_bd_intf_pins g_inst/slot_0_axis]
  ...
  connect_bd_net -net SLOT_0_VID_IO_data_1 [get_bd_ports SLOT_0_VID_IO_data] [get_bd_pins ila_lib/probe1]
  connect_bd_net -net SLOT_0_VID_IO_field_1 [get_bd_ports SLOT_0_VID_IO_field] [get_bd_pins ila_lib/probe2]
  connect_bd_net -net SLOT_0_VID_IO_hblank_1 [get_bd_ports SLOT_0_VID_IO_hblank] [get_bd_pins ila_lib/probe3]
  connect_bd_net -net SLOT_0_VID_IO_hsync_1 [get_bd_ports SLOT_0_VID_IO_hsync] [get_bd_pins ila_lib/probe4]
  connect_bd_net -net SLOT_0_VID_IO_vblank_1 [get_bd_ports SLOT_0_VID_IO_vblank] [get_bd_pins ila_lib/probe5]
  connect_bd_net -net SLOT_0_VID_IO_vsync_1 [get_bd_ports SLOT_0_VID_IO_vsync] [get_bd_pins ila_lib/probe6]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins g_inst/aclk] [get_bd_pins ila_lib/clk]
  connect_bd_net -net net_slot_1_axis_tdata [get_bd_pins g_inst/m_slot_0_axis_tdata] [get_bd_pins ila_lib/probe7]
  connect_bd_net -net net_slot_1_axis_tkeep [get_bd_pins g_inst/m_slot_0_axis_tkeep] [get_bd_pins ila_lib/probe8]
  connect_bd_net -net net_slot_1_axis_tlast [get_bd_pins g_inst/m_slot_0_axis_tlast] [get_bd_pins ila_lib/probe12]
  connect_bd_net -net net_slot_1_axis_tready [get_bd_pins g_inst/m_slot_0_axis_tready] [get_bd_pins ila_lib/probe11]
  connect_bd_net -net net_slot_1_axis_tuser [get_bd_pins g_inst/m_slot_0_axis_tuser] [get_bd_pins ila_lib/probe9]
  connect_bd_net -net net_slot_1_axis_tvalid [get_bd_pins g_inst/m_slot_0_axis_tvalid] [get_bd_pins ila_lib/probe10]
