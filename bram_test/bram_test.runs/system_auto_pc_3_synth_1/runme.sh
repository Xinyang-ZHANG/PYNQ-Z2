...
HD_PWD='D:/self_learning/PYNQ_Z2/prjs/bram_test/bram_test.runs/system_auto_pc_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_auto_pc_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_auto_pc_3.tcl
