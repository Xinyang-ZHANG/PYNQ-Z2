...
HD_PWD='D:/self_learning/PYNQ_Z2/prjs/mnist_test/mnist_test.runs/pooling_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pooling_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pooling_ram.tcl
