...
HD_PWD='D:/self_learning/PYNQ_Z2/prjs/mnist_test/mnist_test.runs/b2_blkmem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log b2_blkmem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source b2_blkmem.tcl
