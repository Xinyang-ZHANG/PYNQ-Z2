...
HD_PWD='D:/self_learning/PYNQ_Z2/prjs/mnist_test/mnist_test.runs/test_imgrom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_imgrom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_imgrom.tcl
