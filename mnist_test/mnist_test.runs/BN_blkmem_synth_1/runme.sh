...
HD_PWD='D:/self_learning/PYNQ_Z2/prjs/mnist_test/mnist_test.runs/BN_blkmem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BN_blkmem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BN_blkmem.tcl
