...
HD_PWD='D:/self_learning/PYNQ_Z2/prjs/mnist_test/mnist_test.runs/W2_blkmem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log W2_blkmem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source W2_blkmem.tcl
