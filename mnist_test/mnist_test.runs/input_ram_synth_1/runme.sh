...
HD_PWD='D:/self_learning/PYNQ_Z2/prjs/mnist_test/mnist_test.runs/input_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log input_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source input_ram.tcl
