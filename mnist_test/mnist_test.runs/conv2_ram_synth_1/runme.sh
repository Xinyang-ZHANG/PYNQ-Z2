...
HD_PWD='D:/self_learning/PYNQ_Z2/prjs/mnist_test/mnist_test.runs/conv2_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conv2_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv2_ram.tcl
