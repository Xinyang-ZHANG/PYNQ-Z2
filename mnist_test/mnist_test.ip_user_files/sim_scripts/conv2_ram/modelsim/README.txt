...
#
# Generated by export_simulation on Thu Jul 06 21:54:41 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './conv2_ram.sh' script.

./conv2_ram.sh -reset_run
...
./conv2_ram.sh -noclean_files

For more information on the script, please type './conv2_ram.sh -help'.
