...
#
# Generated by export_simulation on Thu Jul 06 21:17:14 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './layer1_ram.sh' script.

./layer1_ram.sh -reset_run
...
./layer1_ram.sh -noclean_files

For more information on the script, please type './layer1_ram.sh -help'.
