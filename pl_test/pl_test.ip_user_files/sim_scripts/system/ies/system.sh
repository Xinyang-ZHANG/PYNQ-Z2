...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"../../../../pl_test.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../pl_test.srcs/sources_1/bd/system/ipshared/8c62/hdl" \
       +incdir+"../../../../pl_test.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" \
