...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xlconstant_v1_1_6 -L xlconcat_v2_1_3 -L v_vid_in_axi4s_v4_0_9 -L v_demosaic_v1_0_5 -L blk_mem_gen_v8_4_3 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot system xil_defaultlib.system xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim system -key {Behavioral:sim_1:Functional:system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_8422.protoinst" -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
