...
# IP: bd/system/ip/system_red_block_mnist_0_0/system_red_block_mnist_0_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_red_block_mnist_0_0 || ORIG_REF_NAME==system_red_block_mnist_0_0} -quiet] -quiet

# IP: bd/system/ip/system_mnist_0_0/system_mnist_0_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_mnist_0_0 || ORIG_REF_NAME==system_mnist_0_0} -quiet] -quiet
